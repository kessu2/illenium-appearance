...
Config.ChargePerTattoo = false -- Charge players per tattoo. Set true to enable cost. Config.TattooCost will become the cost of 1 tattoo. The cost can be overridden by adding `cost` key in shared/tattoos.lua for specific tattoos
...
-- true = kaikki voivat käyttää vaatemenua ite (eli ei voi antaa muille)
-- false = vaa Config.PedMenuGroup voi käyttää vaatemenua ja antaa /pedmenu komennolla muille
Config.PedMenuAll = true
